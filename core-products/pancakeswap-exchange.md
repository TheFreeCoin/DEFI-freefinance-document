...
The liquidity provided to the exchange comes from Liquidity Providers \("LPs"\) who stake their tokens in "Pools". In exchange, they get FLIP \(FreeFinance Liquidity Provider\) tokens, which can also be staked to earn CAKE tokens in the "farm".
